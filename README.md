...
**Deployed frontend (Render):** set build-time env var `VITE_API_URL=https://secure-v2v-protocol.onrender.com` (see `web/frontend/.env.example`). Local dev omits this and uses `/api` via the proxy.
